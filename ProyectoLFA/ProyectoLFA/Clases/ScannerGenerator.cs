...
namespace ProyectoLFA.Classes
{
    class ScannerGenerator
    {
        public static string[] GetSourceCode(ET tree)
        {
            ...
            string sourceCode = Clases.Resource1.Program;
            string LineasdeCodigo = Clases.Resource1.Final;
        ...
        private static string getReservedValues(List<Clases.Action> words)
        {
            string output = "";
